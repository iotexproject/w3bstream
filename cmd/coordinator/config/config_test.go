...
func TestConfig_Init(t *testing.T) {
	...
	t.Run("UseEnvConfig", func(t *testing.T) {
		...
		expected := config.Config{
			...
			SchedulerEpoch:             10,
			BlockNumberContractAddress: "0x",
			MultiCallContractAddress:   "0x",
		}
		...
		_ = os.Setenv("BLOCK_NUMBER_CONTRACT_ADDRESS", expected.BlockNumberContractAddress)
		_ = os.Setenv("MULTICALL_CONTRACT_ADDRESS", expected.MultiCallContractAddress)
