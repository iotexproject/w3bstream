...
unit_test:
	GOARCH=amd64 CGO_LDFLAGS='-L./cmd/sequencer/lib/linux-x86_64 -lioConnectCore' go test -gcflags="all=-N -l" `go list ./... | grep -v github.com/iotexproject/w3bstream/cmd/e2etest` -covermode=atomic -coverprofile cover.out
