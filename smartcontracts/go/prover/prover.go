...
//
// Solidity: function initialize(string _name, string _symbol, address _minter) returns()
func (_Prover *ProverTransactor) Initialize(opts *bind.TransactOpts, _name string, _symbol string, _minter common.Address) (*types.Transaction, error) {
	return _Prover.contract.Transact(opts, "initialize", _name, _symbol, _minter)
}

// Initialize is a paid mutator transaction binding the contract method 0x077f224a.
//
// Solidity: function initialize(string _name, string _symbol, address _minter) returns()
func (_Prover *ProverSession) Initialize(_name string, _symbol string, _minter common.Address) (*types.Transaction, error) {
	return _Prover.Contract.Initialize(&_Prover.TransactOpts, _name, _symbol, _minter)
}

// Initialize is a paid mutator transaction binding the contract method 0x077f224a.
//
// Solidity: function initialize(string _name, string _symbol, address _minter) returns()
func (_Prover *ProverTransactorSession) Initialize(_name string, _symbol string, _minter common.Address) (*types.Transaction, error) {
	return _Prover.Contract.Initialize(&_Prover.TransactOpts, _name, _symbol, _minter)
}

// Mint is a paid mutator transaction binding the contract method 0x94bf804d.
//
// Solidity: function mint(uint256 _type, address _account) returns(uint256 id_)
func (_Prover *ProverTransactor) Mint(opts *bind.TransactOpts, _type *big.Int, _account common.Address) (*types.Transaction, error) {
	return _Prover.contract.Transact(opts, "mint", _type, _account)
}

// Mint is a paid mutator transaction binding the contract method 0x94bf804d.
//
// Solidity: function mint(uint256 _type, address _account) returns(uint256 id_)
func (_Prover *ProverSession) Mint(_type *big.Int, _account common.Address) (*types.Transaction, error) {
	return _Prover.Contract.Mint(&_Prover.TransactOpts, _type, _account)
}

// Mint is a paid mutator transaction binding the contract method 0x94bf804d.
//
// Solidity: function mint(uint256 _type, address _account) returns(uint256 id_)
func (_Prover *ProverTransactorSession) Mint(_type *big.Int, _account common.Address) (*types.Transaction, error) {
	return _Prover.Contract.Mint(&_Prover.TransactOpts, _type, _account)
}
